require './application'
Tears::Application.initialize!

# Development middlewares
if Tears::Application.env == 'development'
  ...
  use Rack::Static, :urls => ["/javascripts"], :root => Tears::Application.root(:public)
end
